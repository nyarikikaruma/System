        ...
        <div>
            ...
            <div class="w-full max-w-lg py-8 px-8">
              ...
              <div class="flex mt-8 mx-auto justified-center mb-8 p-4">
                  ...
                  <h1 class=" font-bold underline  text-cyan-800 text-4xl">Edit Region</h1>
  
              </div>
  

              <form method="POST" action="/region/update/{{ $lists->id }}" enctype="multipart/form-data" class="w-full max-w-lg">
                @csrf
                <div class="w-full max-w-lg py-8 px-8">
                  ...
                  <div class="w-full px-3">
                    ...
                    for="bishop_id">
                      ...
                      <select name="bishop_id" class="appearance-none block w-full bg-gray-200 text-gray-700 
                    ...
                    <option value="{{ $bishop->id }}" class="mt-1 px-1 py-1">{{ $bishop->name }}</option>
                  @endforeach
                  </select>
                      {{-- <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded 
                      py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" 
