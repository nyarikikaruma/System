        ...
        <div>
            ...
            <div class="w-full max-w-lg py-8 px-8">
              ...
              <div class="flex mt-8 mx-auto justified-center mb-8 p-4">
                  ...
                  <h1 class=" font-bold underline  text-cyan-800 text-4xl">Add Region</h1>
  
              </div>
  

              <form method="POST" action="/region/create" enctype="multipart/form-data" class="w-full max-w-lg">
                @csrf
                <div class="w-full max-w-lg py-8 px-8">
